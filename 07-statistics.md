...
>> (1/300) * 0.5 / (((0.5)*(1/300)) + ((0.25)*(1/125))) = 5/11
...
>> Frequentist and bayesian statisticians use models to figure out their final result. However, a Bayesian statistician uses prior knowledge to figure out their final result as well, while a Frequentist does not.
